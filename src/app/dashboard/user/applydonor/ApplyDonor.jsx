                        ...
                        <form className="card-body" onSubmit={handleSubmit(onSubmit)}>
                            ...
                            <div className='md:flex justify-between'>
                                <div className="form-control">
                                    ...
                                    <select defaultValue='A+' className="select select-bordered w-full "  {...register("division", { required: "Please select a Division" })}>
                                ...
                                <div className="form-control">
                                    ...
                                    <select defaultValue='A+' className="select select-bordered w-full "  {...register("district", { required: "Please select a district" })}>
                                        <option selected value="">
                                            Select blood Type
                                        </option>
                                ...
                                <div className="form-control">
                                    ...
                                    <select defaultValue='A+' className="select select-bordered w-full "  {...register("upzila", { required: "Please select a Upzila" })}>
                                        <option selected value="">
                                            Select blood Type
                                        </option>
                                        <option value="A+">A+</option>
                            ...
                            <div>
                                ...
                                <div className="form-control">
                                    ...
                                    <select defaultValue='A+' className="select select-bordered w-full "  {...register("blood", { required: "Please select a blood type" })}>
                                        <option selected value="">
                                            Select blood Type
                                        </option>
                                        <option value="A+">A+</option>
