        ...
        <div className='container mx-auto'>
            <div className='banner'>
                ...
                <div className='overlay-text'>
                    ...
                    <p className='text text-md lg:text-2xl'>We arere here to help and answer any question you might have. We look forward to hearing from you</p>
                </div>
            </div>
<div className="info grid grid-cols-1 md:grid-cols-3 gap-10 mt-20">
            <div className="phone border border-red-700 rounded-lg py-5">
