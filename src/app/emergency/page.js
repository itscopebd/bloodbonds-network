...
//   className='mt-10 justify-center mx-auto bg-red-50 p-10 card flex-shrink-0 w-full shadow-2xl max-w-4xl rounded-lg py-8 px-10 flex flex-grow overflow-y-auto'
// >
//   <div className='flex flex-col md:flex-row'>
//     <div className='md:w-1/2 md:pr-4'>
//       <label htmlFor='message' className='text-md md:text-lg font-bold'>
//         Message:
//       </label>
//       <textarea
//         id='message'
...
//   </div>
//   <div className='w-full max-w-xs mt-3'>
//     <label htmlFor='urgencyLevel' className='text-md md:text-lg font-bold'>
//       Urgency Level:
//     </label>
//     <select
//       id='urgencyLevel'
...
//     <label className='text-md md:text-lg font-bold'>Message Preview:</label>
//     <textarea
//       className='message-preview border border-red-700 italic overflow-y-auto ms-2 p-2'
...
//     </textarea>
//   </div>
//   <button type='submit' className='mx-auto w-48 btn btn-error mt-5'>
//     Send Notification
//   </button>
// </form>
